        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: Theme.of(context).textTheme.labelMedium!.copyWith(fontSize: 16.0, fontWeight: FontWeight.w500),
            ),
            const SizedBox(height: 5),
            Text(
              "Remember, you can recover it if you log in within 48 hours.",
              textAlign: TextAlign.center,
              style: Theme.of(context).textTheme.labelMedium!.copyWith(fontSize: 12.0, fontWeight: FontWeight.w400),
            ),
